 ...
 */
public class EnemyTreeList<E> extends AbstractList<E> {
...
//  LinkedList =  270;7360;3350;55860;290720;2910;55200;
     ...
     */
    public EnemyTreeList(final Collection<? extends E> coll) {
        super();
        if (!coll.isEmpty()) {
...
//        }
    ...
    static class TreeListIterator<E> implements ListIterator<E>, OrderedIterator<E> {
        /** The parent list */
        private final EnemyTreeList<E> parent;
        /**
         ...
         */
        protected TreeListIterator(final EnemyTreeList<E> parent, final int fromIndex) throws IndexOutOfBoundsException {
            super();
            this.parent = parent;
